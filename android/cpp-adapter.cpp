...
// Automated testing checks Java_com_nostrsdk_NostrSdkModule and nostrsdk
...
// Installer coming from NostrSdkModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_nostrsdk_NostrSdkModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return nostrsdk::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_nostrsdk_NostrSdkModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return nostrsdk::cleanupRustCrate(*runtime);
}